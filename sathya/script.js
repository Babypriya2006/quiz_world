...
function showResults() {
    ...
    // Store user answers with correct answers
    
    let quizReview = questions.map((q, index) => {
        let correctAnswer = q.answers.find(ans => ans.correct).text; // Extract the correct answer
        return {
            question: q.question,
            selectedAnswer: userAnswers[index] || "Not Answered",
            correctAnswer: correctAnswer || "Not Found",
